...
import { SkillsCardContainer, SkillsCard } from './Styled-Components/MySkills.styles'
    ...
    <PaddingContainer id='Skills' top="10%" bottom="10%" responsiveLeft="1rem" responsiveRight="1rem">
        <FlexContainer  responsiveFlex responsiveDirection="column-reverse" fullWidthChild>
            ...
            <motion.div variants={fadeInRightVariant} initial="hidden"  whileInView="visible">
                ...
                <ParaText top="2rem" bottom="1.5rem">As a developer, I have some experience in front-end web development. I am proficient in JavaScript, React,  HTML, and CSS. My strong experience in building responsive and dynamic user interfaces using React and Redux has allowed me to create engaging and interactive web applications.</ParaText>
